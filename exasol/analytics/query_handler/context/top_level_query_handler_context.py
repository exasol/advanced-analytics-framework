...
from exasol.analytics.query_handler.context.proxy.table_name_proxy import TableNameProxy
from exasol.analytics.query_handler.context.proxy.udf_name_proxy import UDFNameProxy
...
from exasol.analytics.query_handler.query.query import Query
