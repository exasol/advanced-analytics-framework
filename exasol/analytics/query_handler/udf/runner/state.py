...
class QueryHandlerRunnerState:
    ...
    connection_lookup: UDFConnectionLookup | None = None
    input_query_query_handler_context: ScopeQueryHandlerContext | None = None
    input_query_output_columns: list[Column] | None = None
