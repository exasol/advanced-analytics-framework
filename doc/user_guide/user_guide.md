...
Here comes the main SQL command creating the UDF script and executing the scripts with the argument defined as Json string:

<!-- generated by example/generator.py -->
