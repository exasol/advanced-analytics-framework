...
from exasol_advanced_analytics_framework.udf_communication.messages import AcknowledgePayloadMessage, PayloadMessage, \
    Message
...
class PayloadSender:
    ...
    def received_acknowledge_payload(self, message: AcknowledgePayloadMessage):
        ...
        if message.sequence_number in self._payload_message_sender_dict:
            self._payload_message_sender_dict[message.sequence_number].received_acknowledge_payload()
