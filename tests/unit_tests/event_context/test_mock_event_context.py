...
from exasol_advanced_analytics_framework.event_context.mock_event_context import MockEventContext
...
def test_fetch_as_dataframe_column_names():
    context = MockEventContext(data=INPUT_DATA, columns=INPUT_COLUMNS)
