...
def test_create_poller():
    with zmq.Context() as context:
        ...
        assert isinstance(poller, ZMQPoller) and isinstance(
            poller._internal_poller, zmq.Poller
        )
